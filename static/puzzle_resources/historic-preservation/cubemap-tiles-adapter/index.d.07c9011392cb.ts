 ...
 */
declare class CubemapTilesAdapter extends AbstractAdapter<CubemapTilesPanorama, Texture[]> {
...
export { CubemapTilesAdapter, CubemapTilesAdapterConfig, CubemapTilesPanorama };
